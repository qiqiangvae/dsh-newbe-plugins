...
/** 两个跨版本接缝给测试用（`test/sessionnav.test.mjs` 从客户端产物里取，锁住"新 API 优先、老 API 回退"）。 */
export { createSessionOpener, currentSessionId };
...
// 收藏夹图标 = 宿主的文件夹字形 + 一枚实心星（宿主图标集里没有星形，星是本插件画在 .mf-folderStar 里的覆盖层）。
