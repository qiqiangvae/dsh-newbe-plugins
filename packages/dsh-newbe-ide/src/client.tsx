...
const REMOTE_CONTRIBUTION = {
  ...
  descriptors: [
    ...
    },
    {
      ...
      method: 'start',
      invocation: { kind: 'direct' as const },
      parameters: [{ name: 'target', wire: 'target', source: 'json' as const, codec: strictCodec('dsh-newbe-ide#RunTarget', runTargetSchema) }],
    ...
    },
    {
      ...
      method: 'read',
      invocation: { kind: 'direct' as const },
      parameters: [{ name: 'request', wire: 'request', source: 'json' as const, codec: strictCodec('dsh-newbe-ide#RunReadRequest', runReadRequestSchema) }],
    ...
    },
    {
      ...
      method: 'discover',
      invocation: { kind: 'direct' as const },
      parameters: [{ name: 'request', wire: 'request', source: 'json' as const, codec: strictCodec('dsh-newbe-ide#IdeaDiscoveryRequest', ideaDiscoveryRequestSchema) }],
    ...
    },
    {
      ...
      method: 'history',
      invocation: { kind: 'direct' as const },
      parameters: [{ name: 'request', wire: 'request', source: 'json' as const, codec: strictCodec('dsh-newbe-ide#LogHistoryRequest', logHistoryRequestSchema) }],
    ...
    },
    {
      ...
      invocation: { kind: 'direct' as const },
      parameters: [
        { name: 'next', wire: 'next', source: 'json' as const, codec: strictCodec('dsh-newbe-ide#IdeStateInput', ideStateSchema) },
      ],
    ...
    },
    {
      ...
      method: 'secretInfo',
      invocation: { kind: 'direct' as const },
      parameters: [{ name: 'request', wire: 'request', source: 'json' as const, codec: strictCodec('dsh-newbe-ide#SecretQuery', secretQuerySchema) }],
    ...
    },
    {
      ...
      method: 'secretSet',
      invocation: { kind: 'direct' as const },
      parameters: [{ name: 'request', wire: 'request', source: 'json' as const, codec: strictCodec('dsh-newbe-ide#SecretSet', secretSetSchema) }],
